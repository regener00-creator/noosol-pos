...
const formStart = source.indexOf('function contactEditorFieldsHtml(c)');
...
assert.match(source, /openPOSCustomerCreateModal\(\)[\s\S]*contactEditorFieldsHtml\(emptyCustomerContactDraft\(\)\)/);
