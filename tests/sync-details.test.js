...
assert.match(app, /if\(syncChip\) syncChip\.onclick=\(\)=>openSyncDetailsModal\(\);/, 'ทุกสถานะต้องเปิดรายละเอียด ไม่สั่งซิงก์ซ้ำทันที');
assert.match(app, /chip\.title='กดเพื่อดูรายละเอียดการซิงก์'/);
