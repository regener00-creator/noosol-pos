...
assert.ok(ownerEditorHtml.indexOf('id="inspectionListCategory"') < ownerEditorHtml.indexOf('id="inspectionListBrand"'));
assert.ok(ownerEditorHtml.indexOf('id="inspectionListBrand"') < ownerEditorHtml.indexOf('id="inspectionListAddCategoryBtn"'));
