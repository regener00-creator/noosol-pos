...
(async()=>{
  ...
  assert.deepEqual(await page.locator('.customer-tier-choice').allTextContents(),['ลูกค้าทั่วไป','ลูกค้าประจำ✓ ระดับนี้','ลูกค้าพิเศษ']);
  assert.equal(await page.locator('.customer-tier-choice.is-current').getAttribute('aria-current'),'true');
  assert.equal(await page.locator('.customer-tier-choice.is-current').textContent(),'ลูกค้าประจำ✓ ระดับนี้');
