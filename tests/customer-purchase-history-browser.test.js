...
(async()=>{
  ...
  await page.evaluate(async()=>{
    ...
    window.customerRpc=async(name,p)=>{
      if(name==='get_customer_loyalty')return {error:null,data:p.p_customer_ids.map(id=>({customerId:id,balance:Number(id)*25,joinedOn:'2026-09-11',expiresOn:'2027-09-11',expiresAt:'2027-09-11T00:00:00+07:00'}))};
