...
assert.match(receiptLogic, /business=\{\.\.\.\(sale\.businessSnapshot\|\|businessSettings\),line:sale\.businessSnapshot\?\.line\|\|businessSettings\.line\|\|''\}/, 'บิลย้อนหลังที่ไม่มี LINE ต้องใช้ LINE ปัจจุบันจากตั้งค่าธุรกิจ');
