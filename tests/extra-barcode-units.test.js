...
assert.match(formSource, /บาร์โค้ดเพิ่มเติม <span[^>]*>• เผื่อสินค้าเปลี่ยนเลขบาร์โค้ดในล็อตใหม่ — ยิงเลขไหนก็เจอสินค้าตัวเดียวกัน<\/span>/, 'คำอธิบายต้องอยู่ต่อท้ายหัวข้อบาร์โค้ดเพิ่มเติม');
assert.match(formSource, /บาร์โค้ดผู้จำหน่าย <span[^>]*>• เผื่อผู้จำหน่ายแต่ละเจ้ามีเลขบาร์โค้ดของตัวเอง — ยิงแล้วก็เจอสินค้าตัวนี้<\/span>/, 'คำอธิบายต้องอยู่ต่อท้ายหัวข้อบาร์โค้ดผู้จำหน่าย');
