...
const purchaseSectionIndex = navSource.indexOf("{section:'ซื้อและรับสินค้า'");
...
assert.ok(purchaseOrder2NavIndex > purchaseSectionIndex && goodsReceiptNavIndex > purchaseOrder2NavIndex && productReturnNavIndex > goodsReceiptNavIndex && productReturnNavIndex < salesDocumentsSectionIndex, 'เอกสารซื้อและคืนสินค้าต้องอยู่ในหมวดซื้อและรับสินค้า');
