...
(async () => {
  ...
  assert.equal(await page.locator('[data-representative-product-toggle]').count(),3,'opening the popup must show only selected products');
  assert.equal(await page.locator('[data-representative-product-toggle="23"]').count(),0,'unselected products must stay hidden until searched');
